...
function roots_scripts() {
  ...
  wp_enqueue_style('bxslider', get_template_directory_uri() . '/assets/bxslider/jquery.bxslider.css', 'theme', $version, 'screen, projection');
  ...
  wp_enqueue_script('bxslider', get_template_directory_uri() . "/assets/bxslider/jquery.bxslider.min.js", array('jquery'), '1.2.3', true);
}
